...
class Qwen3VLVideoProcessor(BaseVideoProcessor):
    ...
    def _preprocess(
        ...
        **kwargs,
        ...
        grouped_videos, grouped_videos_index = group_videos_by_shape(videos) #按照视频h w大小分组，加快计算
        resized_videos_grouped = {}

        for shape, stacked_videos in grouped_videos.items():
            B, T, C, H, W = stacked_videos.shape
            num_frames, height, width = T, H, W #32 448 640
        ...
        resized_videos = reorder_videos(resized_videos_grouped, grouped_videos_index) #复原回原来的视频顺序
        ...
        for shape, stacked_videos in grouped_videos.items():
            ...
            # do_normalize=True do_rescale=True stacked_videos:[0,255]
