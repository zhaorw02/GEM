        ...
        if image_grid_thw is not None:
            if video_images:
                ...
                for i in range(len(text)):
                    text[i] = text[i].replace(self.vision_start_token, "")
                    text[i] = text[i].replace(self.vision_end_token, "")
                    while self.image_token in text[i]:
                        num_image_tokens = image_grid_thw[index].prod() // merge_length
                        image_placeholder = self.vision_start_token + "<|placeholder|>" * num_image_tokens + self.vision_end_token
