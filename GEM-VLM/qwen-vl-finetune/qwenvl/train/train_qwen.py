...
def set_model(model_args, model):
    ...
    if model_args.tune_generator:
        for n, p in model.sana.named_parameters():
            p.requires_grad = True
    else:
        for n, p in model.sana.named_parameters():
            p.requires_grad = False
    
    if model_args.tune_vae:
    ...
    if model_args.tune_connector:
        for n, p in model.diffusion_connector.named_parameters():
            p.requires_grad = True
    else:
        for n, p in model.diffusion_connector.named_parameters():
            p.requires_grad = False
