...
def fetch_video(ele: Dict[str, Any], image_patch_size: int = 14, return_video_sample_fps: bool = False,
    ...
    max_pixels = max(min(VIDEO_FRAME_MAX_PIXELS, total_pixels / nframes * FRAME_FACTOR), int(min_pixels * 1.05)) #这个会随total_pixels变
    ...
    if "resized_height" in ele and "resized_width" in ele:
        ...
        resized_height, resized_width = smart_resize( #true
            height,
            width,
            factor=image_factor,
            min_pixels=min_pixels,
