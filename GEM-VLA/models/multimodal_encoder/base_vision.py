...
Source: https://github.com/TRI-ML/prismatic-vlms/blob/main/prismatic/models/backbones/vision/base_vision.py
"""

from abc import ABC, abstractmethod
from dataclasses import dataclass
from functools import partial
from typing import Any, Callable, Dict, Optional, Protocol, Tuple, Sequence, Union
...
def unpack_seq(fn: Callable[[Any], Tuple[Any]]) -> Callable[[Any], Any]:
...
class LetterboxPad:
    ...
    def __call__(self, image: Optional[Image] = None) -> Image:
        """Given a PIL.Image, pad to square by adding a symmetric border around the height/width."""
        if image is None:
            # initialize image as a square with padding_fill_value
            return PIL.Image.new("RGB", (self.default_image_size, self.default_image_size), self.padding_fill_value)
...
class TimmViTBackbone(VisionBackbone, ABC):
    def __init__(
        ...
        self.featurizer.forward = unpack_seq(
